...
function LeftMenu(props) {
  return (
    ...
    <SubMenu title={<span>이용 안내</span>}>
        <Menu.Item key="setting:1">▶ 이용 안내</Menu.Item>
        <Menu.Item key="setting:2">▶ 개발자 소개</Menu.Item>
    </SubMenu>
    <SubMenu title={<span>토론의 장</span>}>
        <Menu.Item key="setting:1">▶ 진행중인 토론</Menu.Item>
        <Menu.Item key="setting:2">▶ 지난 토론</Menu.Item>
        <Menu.Item key="setting:3">▶ 토론 주제 신청</Menu.Item>
    </SubMenu>
    <SubMenu title={<span>문의하기</span>}>
        <Menu.Item key="setting:1">▶ 문의하기</Menu.Item>
    </SubMenu>
  </Menu>
  )
}
